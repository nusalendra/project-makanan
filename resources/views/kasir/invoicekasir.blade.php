...
table { font-size: 75%; table-layout: fixed; width: 100%; text-align: center;}
table { border-collapse: separate; border-spacing: 2px; text-align: center; }
th, td { border-width: 1px; padding: 0.5em; position: relative; text-align: center; }
th, td { border-radius: 0.25em; border-style: solid; text-align: center; }
th { background: #EEE; border-color: #BBB; text-align: center; }
...
@page { margin: 0; }
	...
	<body>
		<header>
			<h1>Invoice</h1>
            <a href="/downloadPDF/cetakinvoicekasir"><button type="button" class="btn btn-default btn-lg w3-red" data-toggle="modal" data-target="#myModal1">Checkout</button></a>
			<address contenteditable>
			<img src="asset/images/logo_sushi.jpg" alt="logo sushi_key" width="100" height="60"> 
			</address>
