...
<body class="w3-light-grey w3-content" style="max-width:1600px">
    ...
    <nav class="w3-sidebar w3-collapse w3-red w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
        ...
        <div class="w3-bar-block">
            ...
            <a href="tambahlokasi" onclick="w3_close()" class="w3-bar-item w3-button w3-padding"><i
                    class="fa fa-map-marker fa-fw w3-margin-right"></i>DATA LOKASI</a>
                ...
                <div class="modal-body">
                    <form action="{{ route('editlokasi', ['id' => $data_lokasi->id]) }}" method="GET">
                        ...
                        <div class="form-group">
                            ...
                            <input name="kode"type="" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" value="{{ $data_lokasi->kode }}">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Lokasi Outlet</label>
                            <input name="nama_lokasi"type="" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" value="{{ $data_lokasi->nama_lokasi }}">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Nama Jalan</label>
                            <input name="jalan"type="" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" value="{{ $data_lokasi->jalan }}">
                        </div>
