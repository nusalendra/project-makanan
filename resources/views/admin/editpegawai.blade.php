...
<body class="w3-light-grey w3-content" style="max-width:1600px">
    ...
    <nav class="w3-sidebar w3-collapse w3-red w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
        ...
        <div class="w3-bar-block">
            ...
            <a href="/loginkaryawan" onclick="w3_close()" class="w3-bar-item w3-button w3-padding"><i
                ...
                <div class="modal-body">
                    <form action="{{ route('editpegawai', ['id' => $data_pegawai->id]) }}" method="GET">
                        ...
                        <div class="form-group">
                            ...
                            <input name="nip"type="" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" value="{{ $data_pegawai->nip }}">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Nama Pegawai</label>
                            <input name="nama_pegawai"type="" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" value="{{ $data_pegawai->nama_pegawai }}">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Username</label>
                            <input name="username"type="" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" value="{{ $data_pegawai->username }}">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Password</label>
                            <input name="password"type="" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" value="{{ $data_pegawai->password }}">
                        </div>
                        ...
                        <div class="cols-sm-10">
                            <div class="input-group">
                                <select name="lokasi_penempatan"class="form-control" id="exampleFormControlSelect1"
                                    value="{{ $data_pegawai->lokasi_penempatan }}">
