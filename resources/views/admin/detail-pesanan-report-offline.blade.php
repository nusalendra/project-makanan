        ...
        <div class="w3-container">
            ...
            <div class="w3-container">
                <div class="w3-row-padding">
                    ...
                    <div class="w3-half">
                        ...
                        <p><b>Uang Dibayarkan : Rp. {{ number_format($data->first()->pembeli->uang_dibayarkan, 0, ',', '.') }}</b></p>
                        <p><b>Uang Kembalian : Rp. {{ number_format($data->first()->pembeli->uang_dibayarkan - $data->first()->pembeli->total_harga_semua_pesanan, 0, ',', '.') }}</b></p>
                    </div>
                </div>
            ...
            <div class="w3-row-padding w3-margin-top">
                <div class="w3-half" style="display: flex;">
                    <a href="/report-pesanan-offline" class="w3-button w3-white w3-hover-red w3-border"
