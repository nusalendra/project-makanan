...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.5.0/js/bootstrap.min.js"></script>
  ...
  <div class="d-lg-flex half">
    ...
    <div class="bg order-1 order-md-2" style="background-image: url('asset/images/sushi_2.jpg');"></div>
    <div class="contents order-2 order-md-1">
      ...
      <div class="container">
        <div class="row align-items-center justify-content-center">
          ...
          <h3 class="text-center"><strong> Login Karyawan</strong></h3>
            <p class="mb-4 text-center"><strong></strong></p>
              ...
              <a href="/homekaryawan"><button type="submit"class="btn btn-primary btn-block">Log In</button></a>
              <br>
