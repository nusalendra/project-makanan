                ...
                <div class="modal-body">
                    <form action="/addlokasi" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input name="nama_lokasi"type="text" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Nama Jalan</label>
                            <input name="jalan"type="text" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp">
                        </div>
                </div>
        ...
        <table class="table">
            ...
            @foreach ($data_lokasi as $lokasi)
                <tr>
                    ...
                    <td>{{ $lokasi->jalan }}</td>
                    <td><a href="/prosesviewdatalokasi/{{ $lokasi->id }}" class="btn fa fa-edit w3-blue"></a><a>
                        </a><a href="/deletelokasi/{{ $lokasi->id }}" class="btn fa fa-trash w3-red"></a></td>
                </tr>
            @endforeach
            </tr>
